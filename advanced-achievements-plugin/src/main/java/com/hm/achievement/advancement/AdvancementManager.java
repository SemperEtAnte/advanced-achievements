...
public class AdvancementManager implements Reloadable
{
    ...
    private void registerOtherAdvancements()
    {
        ...
        {
            if (mainConfig.getBoolean("showCommandsInBukkit", true))
            {
        ...
        {
            //logger.info("Register NormalAchievements " + category);
        ...
        for (MultipleAchievements category : MultipleAchievements.values())
        {
            ...
            {
                //logger.info("Register MultipleAchievements " + category + "." + section);
                                       ...
                                       boolean lastAchievement)
    {
        ...
        String ic = mainConfig.getString(configAchievement + ".Icon", "");
        String ul = "config.yml ( " + configAchievement + ".Icon)";
        ...
        if (ic == null || ic.isEmpty())
        {
            ...
            ic = guiConfig.getString(path);
            ul = "gui.yml (" + path + ")";
        }
        Material material = materialHelper.matchMaterial(ic, Material.BOOK, ul);
